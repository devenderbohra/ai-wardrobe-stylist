...
import { ClothingItem, ClothingCategory, ClothingType, ColorFamily, StyleType, Season } from '@/src/types';
...
export const SAMPLE_CLOTHING_ITEMS = [
  {
    ...
    colors: ["white"] as ColorFamily[],
    primaryColor: "white" as ColorFamily,
    style: "business" as StyleType,
    season: ["spring", "summer", "fall", "winter"] as Season[],
  ...
  },
  {
    ...
    colors: ["blue"] as ColorFamily[],
    primaryColor: "blue" as ColorFamily,
    style: "casual" as StyleType,
    season: ["spring", "fall", "winter"] as Season[],
  ...
  },
  {
    ...
    type: "cocktail" as ClothingType,
    imageUrl: "https://images.unsplash.com/photo-1566479179817-c62b8ed2b518?w=400",
    colors: ["black"] as ColorFamily[],
    primaryColor: "black" as ColorFamily,
    style: "elegant" as StyleType,
    season: ["spring", "summer", "fall"] as Season[],
  ...
  },
  {
    ...
    colors: ["navy"] as ColorFamily[],
    primaryColor: "navy" as ColorFamily,
    style: "business" as StyleType,
    season: ["spring", "fall", "winter"] as Season[],
  ...
  },
  {
    ...
    colors: ["white", "navy"] as ColorFamily[],
    primaryColor: "white" as ColorFamily,
    style: "casual" as StyleType,
